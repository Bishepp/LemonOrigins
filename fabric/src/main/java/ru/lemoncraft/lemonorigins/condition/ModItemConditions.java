...
public class ModItemConditions {
    public static void register() {
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_cursed"), new SerializableData(), (data, stack) -> {
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_melee_weapon"), new SerializableData(), (data, stack) ->
                Enchantments.SHARPNESS.canEnchant(stack) || stack.getItem() instanceof DiggerItem && ((DiggerItem) stack.getItem()).getAttackDamage() > 0
        ));

        register(new ConditionFactory<>(LemonOrigins.loc("is_summon_weapon"), new SerializableData(), (data, stack) ->
                stack.getItem() == Items.BOW || stack.getItem() instanceof DiggerItem || stack.getItem() instanceof SwordItem
        ));

        register(new ConditionFactory<>(LemonOrigins.loc("is_bow"), new SerializableData(), (data, stack) ->
                stack.getItem() instanceof BowItem
        ));

        register(new ConditionFactory<>(LemonOrigins.loc("is_dagger"), new SerializableData(), (data, stack) -> {
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_valkyrie_weapon"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_fist_weapon"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
            return (stack.getItem() instanceof SwordItem || Enchantments.SHARPNESS.canEnchant(stack))
                    && (itemName.contains("fist") || itemName.contains("claw") || itemName.contains("gauntlet"));
        }));

        register(new ConditionFactory<>(LemonOrigins.loc("is_tool"), new SerializableData(), (data, stack) ->
                stack.getItem() instanceof DiggerItem || Enchantments.BLOCK_EFFICIENCY.canEnchant(stack)
        ));

        register(new ConditionFactory<>(LemonOrigins.loc("is_heavy_armor"), new SerializableData(), (data, stack) -> {
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_golden_armor"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
            return (stack.getItem() instanceof ArmorItem && (itemName.contains("gold") || itemName.contains("gilded")));
        }));

        register(new ConditionFactory<>(LemonOrigins.loc("is_silver_armor"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
            return (stack.getItem() instanceof ArmorItem && (itemName.contains("silver") || itemName.contains("iron")));
        }));

        register(new ConditionFactory<>(LemonOrigins.loc("is_golden_weapon"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
            return (stack.getItem() instanceof SwordItem && (itemName.contains("gold") || itemName.contains("gilded")));
        }));

        register(new ConditionFactory<>(LemonOrigins.loc("is_golden_tool"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_axe"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
        ...
        register(new ConditionFactory<>(LemonOrigins.loc("is_silver_weapon"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
            return (stack.getItem() instanceof SwordItem && (itemName.contains("silver") || itemName.contains("iron")));
        }));

        register(new ConditionFactory<>(LemonOrigins.loc("is_silver_tool"), new SerializableData(), (data, stack) -> {
            String itemName = BuiltInRegistries.ITEM.getKey(stack.getItem()).getPath();
