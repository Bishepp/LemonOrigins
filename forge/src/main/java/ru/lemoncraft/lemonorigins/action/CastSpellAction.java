...
public class CastSpellAction extends EntityAction<CastSpellAction.Configuration> {
    ...
    public void execute(Configuration configuration, Entity entity) {
        if (!(entity instanceof LivingEntity)) {
            LemonOrigins.LOGGER.info("Entity is not a LivingEntity: " + entity);
            return;
        }
        ...
        if (spell == null || "none".equals(spell.getSpellName())) {
            LemonOrigins.LOGGER.info("No valid spell found for resource location " + spellResourceLocation);
            return;
        }
        ...
        if (entity instanceof ServerPlayer serverPlayer) {
            ...
            LemonOrigins.LOGGER.info("Entity is not a valid caster (currently only players can cast spells with this entity action): " + entity);
        }
    }
        ...
        if (data != null) {
            ...
            if (data.ticksElapsed >= data.costInterval) {
                ...
                if (magicData.getMana() >= data.manaCost) {
                    ...
                    LemonOrigins.LOGGER.debug("Draining mana: " + data.manaCost + ". Remaining mana: " + magicData.getMana());
                } else {
