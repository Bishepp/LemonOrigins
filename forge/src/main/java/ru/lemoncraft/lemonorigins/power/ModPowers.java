package ru.lemoncraft.lemonorigins.power;

import ru.lemoncraft.lemonorigins.LemonOrigins;
import ru.lemoncraft.lemonorigins.power.factory.IcarusWingsPowerFactory;
import ru.lemoncraft.lemonorigins.power.factory.OwnerAttributeTransferPowerFactory;
...
public class ModPowers {
    public static final DeferredRegister<PowerFactory<?>> POWER_FACTORIES = DeferredRegister.create(ApoliRegistries.POWER_FACTORY_KEY, LemonOrigins.MODID);
